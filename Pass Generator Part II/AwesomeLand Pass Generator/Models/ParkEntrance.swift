...
extension Employee {
    ...
    func contractEmployeeRegistrationCheck(entrant: ContractEmployee) throws {
        ...
        }  else if entrant.projectNumber == "" {
            throw ContractEmployeeRegistrationErrors.missingProjectNumber
        } else if entrant.birthday == "" {
    ...
    func contractEmployeeRegistrationComplete(entrant: ContractEmployee) -> Bool {
        do {
            ...
            return false
        } catch ContractEmployeeRegistrationErrors.missingProjectNumber {
            print("Please enter your project number on the registration form")
            return false
...
extension Vendor {
    ...
    func vendorRegistrationCheck(entrant: Vendor) throws {
        if entrant.firstName == "" {
            throw VendorRegistrationErrors.missingFirstName
        } else if entrant.lastName == "" {
            throw VendorRegistrationErrors.missingLastName
        } else if entrant.vendorCompany == "" {
            throw VendorRegistrationErrors.missingVendorCompany
        } else if entrant.birthday == "" {
    ...
    func vendorRegistrationComplete(entrant: Vendor) -> Bool {
        do {
            ...
            print("Registration is complete")
            return true
        } catch VendorRegistrationErrors.missingFirstName {
            print("Please enter your first name on the registration form")
            return false
        } catch VendorRegistrationErrors.missingLastName {
            print("Please enter your last name on the registration form")
            return false
        } catch VendorRegistrationErrors.missingVendorCompany {
            print("Please enter name of Vendor Company")
            return false
