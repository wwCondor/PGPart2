...
struct MockupGuest {
    ...
    // Contract Employees
    static let mockupContractP1001 = ContractEmployee(projectNumber: .p1001, type: .contract, firstName: "Jill", lastName: "Person", streetAddress: "Street", city: "City", state: "State", zipCode: "Zip", ssn: "12345678", birthday: "15-09-1984")
    static let mockupContractP1002 = ContractEmployee(projectNumber: .p1002, type: .contract, firstName: "Jane", lastName: "Person", streetAddress: "Street", city: "City", state: "State", zipCode: "Zip", ssn: "12345678", birthday: "15-09-1984")
    static let mockupContractP1003 = ContractEmployee(projectNumber: .p1003, type: .contract, firstName: "Jimmy", lastName: "Person", streetAddress: "Street", city: "City", state: "State", zipCode: "Zip", ssn: "12345678", birthday: "15-09-1984")
    static let mockupContractP2001 = ContractEmployee(projectNumber: .p2001, type: .contract, firstName: "Jenny", lastName: "Person", streetAddress: "Street", city: "City", state: "State", zipCode: "Zip", ssn: "12345678", birthday: "15-09-1984")
    static let mockupContractP2002 = ContractEmployee(projectNumber: .p2002, type: .contract, firstName: "James", lastName: "Person", streetAddress: "Street", city: "City", state: "State", zipCode: "Zip", ssn: "12345678", birthday: "15-09-1984")
